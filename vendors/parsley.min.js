...
!function(d){var h=function(a){this.messages={defaultMessage:"<font color='red'>This value seems to be invalid.</font>",type:{email:"<font color='red'>This value should be a valid email.</font>",url:"<font color='red'>This value should be a valid url.</font>",urlstrict:"<font color='red'>This value should be a valid url.</font>",number:"<font color='red'>This value should be a valid number.</font>",digits:"<font color='red'>This value should be digits.</font>",dateIso:"<font color='red'>This value should be a valid date (YYYY-MM-DD).</font>",alphanum:"<font color='red'>This value should be alphanumeric.</font>",phone:"<font color='red'>This value should be a valid phone number.</font>"},notnull:"<font color='red'>This value should not be null.</font>",
notblank:"<font color='red'>This value should not be blank.</font>",required:"<font color='red'>Note: Required</font>",regexp:"<font color='red'>This value seems to be invalid.</font>",min:"<font color='red'>Minimum of %s.</font>",max:"<font color='red'>This value should be lower than or equal to %s.</font>",range:"<font color='red'>This value should be between %s and %s.,/font>",minlength:"<font color='red'>This value is too short. It should have %s characters or more.</font>",maxlength:"<font color='red'>This value is too long. It should have %s characters or less.</font>",rangelength:"<font color='red'>This value length is invalid. It should be between %s and %s characters long.</font>",
mincheck:"<font color='red'>You must select at least %s choices.</font>",maxcheck:"<font color='red'>You must select %s choices or less.</font>",rangecheck:"<font color='red'>You must select between %s and %s choices.</font>",equalto:"<font color='red'>This value should be the same.</font>"};this.init(a)};h.prototype={constructor:h,validators:{notnull:function(){return{validate:function(a){return 0<a.length},priority:2}},notblank:function(){return{validate:function(a){return"string"===typeof a&&""!==a.replace(/^\s+/g,"").replace(/\s+$/g,"")},priority:2}},required:function(){var a=this;return{validate:function(b){if("object"===
